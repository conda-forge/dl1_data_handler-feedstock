About dl1_data_handler-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dl1_data_handler-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dl1_data_handler-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dl1_data_handler
# for installing globally
pixi global install dl1_data_handler
```
...
It is possible to list all of the versions of `dl1_data_handler` available on your platform:
...
```
pixi search dl1_data_handler --channel conda-forge
```
...
* [@alexcervino](https://github.com/alexcervino/)
